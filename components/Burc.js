        ...
        <View style={styles.container}>
            {
                ...
                <View style={styles.change}>
                    ...
                    <Image style={styles.icon} source={change.dolar[0].kur_durum === 's up' ? require('../assets/up.png') : (change.dolar[0].kur_durum === 's down' ? require('../assets/down.png') : require('../assets/equal.png'))}/>
            ...
            }
            {
                ...
                <View style={styles.change}>
                    ...
                    <Image style={styles.icon} source={change.euro[0].kur_durum === 's up' ? require('../assets/up.png') : (change.euro[0].kur_durum === 's down' ? require('../assets/down.png') : require('../assets/equal.png'))}/>
            ...
            }
            {
                ...
                <View style={styles.change}>
                    ...
                    <Image style={styles.icon} source={change.altin[0].kur_durum === 's up' ? require('../assets/up.png') : (change.altin[0].kur_durum === 's down' ? require('../assets/down.png') : require('../assets/equal.png'))}/>
            ...
            }
            {
                ...
                <View style={styles.change}>
                    ...
                    <Image style={styles.icon} source={change.btc[0].kur_durum === 's up' ? require('../assets/up.png') : (change.btc[0].kur_durum === 's down' ? require('../assets/down.png') : require('../assets/equal.png'))}/>
